...
export default {
  ...
  props: {
    ...
    trHeight: [String, Number],

    offsetCount: [String, Number]
  },
  ...
  methods: {
    ...
    bindEvents() {
      ...
      this.bodyWrapper.addEventListener("scroll", function() {
        if (Math.abs(self.setScrollTop - this.scrollTop) > (self.trHeight * self.offsetCount)) {
          self.setScrollTop = this.scrollTop;
        }
  ...
  watch: {
    ...
    bodyHeight: {
      immediate: true,
      handler(value) {
        this.tableHeight = this.layout.bodyHeight ? this.layout.bodyHeight : this.height;
      }
    },
